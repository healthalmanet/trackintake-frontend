...
// Component to display animated numbers
...
// Component to toggle between male and female
...
// Component to display a custom slider
...
// Component to display a number stepper
...
// Component to display general tips
const GeneralTips = () => {
    const tips = [
...
// Component to display result ranges chart
...
// Component to display next steps
const NextSteps = () => {
    const steps = [
