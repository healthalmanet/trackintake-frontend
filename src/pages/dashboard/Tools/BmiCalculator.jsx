...
// Change this to 'health_tools_allowed' if you add that flag later
const REQUIRED_FEATURE = 'weight_tracker_allowed';
  ...
  useEffect(() => {
    const fetchSub = async () => {
      try {
        ...
        setSubscription({ plan: { name: 'Free', weight_tracker_allowed: false } });
      } finally {
        setSubLoaded(true);
      }
    };
